...
// do podpunktu trwałość ekstensji - zapis danych wszystkich ekstensji do pliku persistence.bin; po ponownym odpaleniu będzie można wczytać dane(metoda load() na samej górze), które wcześniej zostały zapisane do pliku
        //Persistence.save();
