...
{\footnotesize Klasyczny przykład zastosowania twierdzenia Bayesa, to przypadek testowania na dosyć rzadką chorobę. Szukamy jakie jest prawdopodobieństwo, że osoba jest chora, jeżeli wyszedł jej pozytywny wynik testu. Załóżmy, że precyzja testu to 95~\%,  choruje 1/100 osób.\\
...
\begin{frame}
	\frametitle{Wyszukiwanie -- na czym polega?}
		...
		Polega na odszukaniu elementu o danej wartości (tzw. klucza) w nieposortowanej lub posortowanej strukturze danych (tablicy lub liście) i zwrócenie indeksu, pod którym znaleziony element się znajduje*. Jeżeli element nie zostanie znaleziony, wyświetlany jest stosowny komunikat (często wartość -1). \\
		\bigskip
...
\begin{frame}
	\frametitle{Wyszukiwanie binarne}
			\begin{block}{Na czym polega??}
{\tiny 			1. W posortowanym ciągu porównuje się wartość klucza z wartością środkowego elementu. Jeżeli są takie same, zwracany jest indeks. \\
	...
	\begin{minipage}{0.55\textwidth}
		\begin{figure}
			\includegraphics[width=0.7\textwidth]{binary_search}
...
\begin{frame}
	\frametitle{Wyszukiwanie poprzez skok co k-ty element}
				\begin{block}{Na czym polega??}
{\scriptsize 			1. W posortowanym ciągu przeskakuje się co k elementów i porównuje się wartość bieżącego elementu z wartością klucza. \\
	...
	\begin{minipage}{0.55\textwidth}
		\begin{figure}
			\includegraphics[width=0.75\textwidth]{skok}
...
\begin{frame}
	...
	\begin{block}{Stabilność}
		...
		Stabilne: np. bąbelkowe, przez scalanie.\\
...
\begin{itemize}
	...
	\item wykorzystuje interfejsy funkcyjne, wyrażenia lambda oraz referencje do metod
...
\begin{frame}
	...
	\item collect -- pozwala na stworzenie nowego typu na podstawie strumienia, np. tablicy
...
\begin{frame}
	...
	\bigskip
Załóżmy, że chcemy otrzymać tylko osoby, które mają major computer science i gpa powyzej 3.25 oraz major ma być pisany cały wielkimi literami. Wyniki chcemy wydrukować w konsoli. \\
	\smallskip
...
\begin{frame}
	...
	Analiza: \\
	\begin{itemize}
	{\footnotesize 	\item Utworzenie strumienia z listy z użyciem metody stream() -- jest to metoda domyślna zaimplementowana w interfejsie Collection. \\
