...
\begin{frame}
	\frametitle{Sortowanie szybkie}
		...
		\begin{minipage}{0.45\textwidth}
%			\begin{figure}
%			\includegraphics[width=1\textwidth]{quicksort}
%			\caption{{\tiny Sortowanie szybkie.}}
%		\end{figure}
Tu nie będzie obrazka - tu będzie raczej opis jego zastosowań. \\
Animacja obrazująca quicksort: \\
\underline{\href{http://algorytmy.ency.pl/tutorial/quicksort}{Click}}
...
\begin{frame}
	...
	\end{block}
	\begin{itemize}
		\item element od razu ma wylądować na swojej docelowej pozycji
	\end{itemize}
\end{frame}
